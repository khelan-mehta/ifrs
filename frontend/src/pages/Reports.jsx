  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-[13px] text-surface-500 mt-0.5">Generate IFRS-compliant report sections</p>
      </div>
      ...
      <div className="card">
        <div className="px-5 py-4 border-b border-surface-100">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="text-sm font-semibold text-surface-900">Generate New Report</h3>
              <p className="text-[11px] text-surface-400">Select a report type and generate</p>
            </div>
          </div>
        </div>
        <div className="p-5">
        ...
        <div className="space-y-2">
          {reports.map((r) => (
            <div key={r.id} className="card overflow-hidden">
              <button
                ...
                className="w-full flex items-center justify-between px-5 py-3.5 text-left hover:bg-surface-50/50 transition-colors"
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[13px] font-medium text-surface-900 capitalize">
              ...
              {expanded === r.id && (
                <div className="px-5 pb-5 border-t border-surface-100">
                  ...
                  <div className="bg-surface-50 rounded-md p-4">
                    <pre className="text-[13px] text-surface-700 whitespace-pre-wrap leading-relaxed font-sans">
                      {r.generated_text}
                    </pre>
                  </div>
                </div>
          ...
          {reports.length === 0 && (
            <div className="flex flex-col items-center justify-center py-10">
              ...
              <p className="text-[13px] text-surface-500">No reports generated yet.</p>
